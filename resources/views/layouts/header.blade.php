          ...
          <div class="navbar-header">
            <div class="d-flex">
              ...
              <form class="app-search d-none d-md-block">
                ...
                <h4 class="card-title mt-2 flex-grow-1">AZAM - TEMESA</h4>
                  <input type="text" class="form-control collapse" placeholder="Search..." autocomplete="off" id="search-options" value="">
                  <span class="mdi mdi-magnify search-widget-icon collapse"></span>
                ...
                <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                  <div data-simplebar style="max-height: 320px;">
                    ...
                    <div class="dropdown-item bg-transparent text-wrap">
                      <a href="{{ url("index-2.html") }}" class="btn btn-soft-secondary btn-sm btn-rounded">how to setup <i class="mdi mdi-magnify ms-1"></i>
                      </a>
                      <a href="{{ url("index-2.html") }}" class="btn btn-soft-secondary btn-sm btn-rounded">buttons <i class="mdi mdi-magnify ms-1"></i>
                      </a>
                    </div>
                    <!-- item-->
                  ...
                  <div class="text-center pt-3 pb-1">
                    <a href="{{ url("pages-search-results.html") }}" class="btn btn-primary btn-sm">View All Results <i class="ri-arrow-right-line ms-1"></i>
                    </a>
                  </div>
                </div>
              </form>
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="dropdown topbar-head-dropdown ms-1 header-item collapse" id="notificationDropdown">
                <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                  <i class='bx bx-bell fs-22'></i>
                  <span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger">0 <span class="visually-hidden">unread messages</span>
                  </span>
                </button>
                    ...
                    <div class="px-2 pt-2">
                      <ul class="nav nav-tabs dropdown-tabs nav-tabs-custom" data-dropdown-tabs="true" id="notificationItemsTab" role="tablist">
                        <li class="nav-item waves-effect waves-light">
                          <a class="nav-link active" data-bs-toggle="tab" href="{{ url("#all-noti-tab") }}" role="tab" aria-selected="false"> All (0) </a>
                        </li>
                        <!-- <li class="nav-item waves-effect waves-light">
                          <a class="nav-link" data-bs-toggle="tab" href="{{ url("#messages-tab") }}" role="tab" aria-selected="false"> Messages </a>
                        </li> -->
                        <li class="nav-item waves-effect waves-light">
                          <a class="nav-link" data-bs-toggle="tab" href="{{ url("#alerts-tab") }}" role="tab" aria-selected="true"> Alerts </a>
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <div class="dropdown ms-sm-3 header-item topbar-user">
                <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span class="d-flex align-items-center">
                    ...
                    <span class="text-start ms-xl-2">
                      <span id="userFullName" class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"></span>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  <!-- item-->
                  <h6 id="first_name" class="dropdown-header"></h6>
                  <a class="dropdown-item" href="{{ url("#") }}">
                    <i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i>
                    <span class="align-middle">Profile</span>
                  </a>
                  <!-- <a class="dropdown-item" href="{{ url("apps-chat.html") }}">
                    <i class="mdi mdi-message-text-outline text-muted fs-16 align-middle me-1"></i>
                    <span class="align-middle">Messages</span>
                  </a> -->
                  <!-- <a class="dropdown-item" href="{{ url("apps-tasks-kanban.html") }}">
